...
from utils.utils import NjuVpn
...
class WosDownloader(object):
    ...
    def __download_by_index(self, markFrom, markTo):
        ...
        # save_button = self.driver.find_element_by_class_name('saveToButton')
        save_menu = Select(self.driver.find_element_by_id('saveToMenu'))
